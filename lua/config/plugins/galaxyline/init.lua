...
gl.short_line_list = {'NvimTree', 'packer', 'DiffviewFiles', 'terminal' }

local schema = require('config.plugins.galaxyline.color').schema
...
local mode_color = function()
  if mode_schema[vim.fn.mode()] == nil then
	  return mode_schema['Unknown'].color
  end
  return mode_schema[vim.fn.mode()].color
end

local mode_text = function()
  if mode_schema[vim.fn.mode()] == nil then
	  return mode_schema['Unknown'].text
  end
  return mode_schema[vim.fn.mode()].text
end
